      ...
      <div class="">
        <form name="login-form" on:submit|preventDefault={handleOnSubmit}>
          <label class="block">
            ...
            <input type="text" autofocus bind:value={credentials.email} class="mt-1 block w-full text-gray-600	 px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
